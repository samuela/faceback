  ...
  * left leg
  ...
  def __init__(
    ...
    if self.base_results_dir is not None:
      ...
      self.results_folder_name = 'grouped_mocap_subject7_' + ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(16))
  ...
  def viz_reconstruction(self, plot_seed, num_examples):
    ...
    true_angles = self.split_into_joints(self.preprocess_inverse(train_sample))
